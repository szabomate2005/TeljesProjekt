...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Jan 05. 16:27
...
(9, 'MSI X570', 'AM4', 'ATX', 3600, 'DDR4', 'X570', 4, 1),
(10, 'ASUS TUF Gaming', 'AM5', 'ATX', 5200, 'DDR5', 'X670', 4, 1),
(11, 'MSI B450', 'AM4', 'ATX', 3200, 'DDR4', 'B450', 4, 1),
(12, 'ASUS ROG Strix', 'LGA1200', 'Micro-ATX', 3600, 'DDR4', 'Z490', 4, 1),
(13, 'Gigabyte Aorus', 'LGA1700', 'ATX', 4000, 'DDR5', 'Z690', 4, 1),
(14, 'MSI MPG', 'AM5', 'ATX', 5200, 'DDR5', 'X670', 4, 1),
(15, 'ASRock Steel Legend', 'AM4', 'Micro-ATX', 3000, 'DDR4', 'B450', 2, 1),
(16, 'ASUS Prime', 'LGA1200', 'ATX', 3400, 'DDR4', 'B560', 4, 1),
(17, 'Gigabyte B550', 'AM4', 'ATX', 3200, 'DDR4', 'B550', 4, 1),
(18, 'ASRock Phantom Gaming', 'LGA1700', 'Micro-ATX', 4800, 'DDR5', 'Z690', 4, 1),
...
INSERT INTO `applikacio` (`Id`, `Nev`, `Tarhely`, `KatId`, `Kepeleresiutja`, `SetupId`) VALUES
(1, 'alma', 57, 1, 'http/dolog', 101),
(2, 'teve', 57, 1, 'http/dolog', 102);
...
INSERT INTO `processzor` (`Id`, `Nev`, `AlaplapFoglalat`, `SzalakSzama`, `TamogatottMemoriatipus`, `ProcesszormagokSzama`, `Gyarto`, `AjanlottTapegyseg`, `IntegraltVideokartya`) VALUES
(1, 'Intel Core i3-10100', 'LGA 1200', 4, 'DDR4', 4, 1, 450, 0),
(2, 'AMD Ryzen 5 3600', 'AM4', 6, 'DDR4', 6, 2, 550, 0),
(3, 'Intel Core i5-10600K', 'LGA 1200', 6, 'DDR4', 6, 1, 500, 0),
(4, 'AMD Ryzen 7 5800X', 'AM4', 8, 'DDR4', 8, 2, 650, 0),
(5, 'Intel Core i9-11900K', 'LGA 1200', 8, 'DDR4', 8, 1, 700, 0);
...
INSERT INTO `profil` (`Id`, `Felhasznalonev`, `Jogosultsag`, `Email`, `Jelszo`, `Tema`) VALUES
...
(1, 'Corsair Vengeance LPX', 1, 3200, 8),
(2, 'G.SKILL Ripjaws V', 1, 3600, 16),
(3, 'Kingston HyperX Fury', 1, 2666, 8),
(4, 'Crucial Ballistix', 1, 3000, 16),
(5, 'Corsair Dominator Platinum', 1, 3600, 32);
...
INSERT INTO `setup` (`Id`, `VidkaId`, `ProcId`, `RamId`, `OpId`, `AlaplId`, `Gp`) VALUES
(101, 1, 1, 1, 1, 1, 'General Setup'),
(102, 2, 2, 2, 2, 2, 'Basic Setup'),
(103, 3, 3, 3, 3, 3, 'Advanced Setup'),
(104, 4, 4, 4, 4, 4, 'Premium Setup'),
(105, 5, 5, 5, 5, 5, 'Ultimate Setup');
...
ALTER TABLE `applikacio`
  ...
  ADD CONSTRAINT `applikacio_ibfk_2` FOREIGN KEY (`SetupId`) REFERENCES `setup` (`Id`);
